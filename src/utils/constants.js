...
export const submitCardButton = addCardModal.querySelector(
  ".popup__submit-button"
);
export const submitProfileButton = editProfileModal.querySelector(
  ".popup__submit-button"
);
export const submitAvatarButton = editAvatarModal.querySelector(
  ".popup__submit-button"
);
